...
<body>
  ...
  <section class="header">
    ...
    <div class="featured-information">
        <h1>NATURAL ESSENTIAL HOME DECOR</h1>
        <a href="route.php?page=story" class="hero-btn">DISCOVER MORE</a>
    </div>
  </section>
  <!--niche info section-->
  <section class="header2">
    <div class="h2-info">
      ...
      <p>Our candles are locally sourced and produced from natural soy wax, coconut wax and bees wax,<br> ensuring that they are sustainable and environmentally friendly</p>
    </div>
  </section>
