...
$total_products = $pdo->query("SELECT * FROM products WHERE productCategory='Candle'")->rowCount();
?>
  ...
  <body>
    ...
    <section class="featured">
      <div class="featured-content">
        <h2>NATURAL SUSTAINABLE SCENTED  CANDLES</h2>
    ...
    <section class="products">
      <div class="product-contents">
        ...
        <div class="product-info">
            ...
            <a href="route.php?page=candleProduct&id=<?=$product['productID']?>&category=<?=$product['productCategory']?>&name=<?=$product['productName']?>" class="product">
        ...
        <div class="buttons">
            ...
            <a href="route.php?page=candles&p=<?=$current_page-1?>">Prev</a>
            <?php endif; ?>
            <?php if ($total_products > ($current_page * $num_products_on_each_page) - $num_products_on_each_page + count($products)): ?>
            <a href="route.php?page=candles&p=<?=$current_page+1?>">Next</a>
            <?php endif; ?>
        </div>
      </div>
    </section>
