...
$total_products = $pdo->query("SELECT * FROM products WHERE productCategory='Diffuser'")->rowCount();
?>
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Shop Diffusers</title>
    <!--Custom stylesheet-->
    <link rel="stylesheet" href="diffusers.css">
    <!--Custom script-->
  ...
  <body>
    <section class="header">
      ...
      <h1>SHOP ESSENTIAL OILS AND DIFFUSERS</h1>
    </section>
    <section class="featured">
      <div class="featured-content">
        <h2>ESSENTIAL OILS AND DIFFUSERS</h2>
        <p>Give your health a beauty treament <br> by shopping our range of essential oils and diffusers</p>
      </div>
    </section>
    <section class="products">
      <div class="product-contents">
        ...
        <div class="product-info">
          ...
          <a href="route.php?page=diffuserProduct&id=<?=$product['productID']?>&category=<?=$product['productCategory']?>&name=<?=$product['productName']?>" class="product">
        ...
        <div class="buttons">
            ...
            <a href="route.php?page=diffusers&p=<?=$current_page-1?>">Prev</a>
            <?php endif; ?>
            <?php if ($total_products > ($current_page * $num_products_on_each_page) - $num_products_on_each_page + count($products)): ?>
            <a href="route.php?page=diffusers&p=<?=$current_page+1?>">Next</a>
            <?php endif; ?>
        </div>
      </div>
    </section>
